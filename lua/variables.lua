...
SPIKER_ADDON_DAMAGE                      = 15
SPIKER_INITIAL_SPEED                     = 1000
SPIKER_ADDON_SPEED                       = 0
SPIKER_COST                              = 35
SPIKER_DELAY                             = 0.3
SPIKER_REFIRE_DELAY                      = 1.0
SPIKER_INITIAL_RANGE                     = 1000
SPIKER_ADDON_RANGE                       = 0
CORPSE_EXPLOSION_INITIAL_DAMAGE          = 100
CORPSE_EXPLOSION_ADDON_DAMAGE            = 40
...
M_SOLDIER_INITIAL_ARMOR                  = 25	-- 175
M_SOLDIER_ADDON_ARMOR                    = 15
M_BERSERKER_INITIAL_HEALTH               = 100	-- 750
M_BERSERKER_ADDON_HEALTH                 = 65
M_BERSERKER_INITIAL_ARMOR                = 0	-- 250
M_BERSERKER_ADDON_ARMOR                  = 25
M_ENFORCER_INITIAL_HEALTH                = 50	-- 500
M_ENFORCER_ADDON_HEALTH                  = 45
M_ENFORCER_INITIAL_ARMOR                 = 0
M_ENFORCER_ADDON_ARMOR                   = 0
M_CHICK_INITIAL_HEALTH                   = 50	-- 200
M_CHICK_ADDON_HEALTH                     = 15
M_CHICK_INITIAL_ARMOR                    = 25	-- 175
M_CHICK_ADDON_ARMOR                      = 15
M_BRAIN_INITIAL_HEALTH                   = 100	-- 500
M_BRAIN_ADDON_HEALTH                     = 40
M_BRAIN_INITIAL_ARMOR                    = 0	-- 1500
M_BRAIN_ADDON_ARMOR                      = 150
M_FLOATER_INITIAL_HEALTH                 = 50	-- 250
M_FLOATER_ADDON_HEALTH                   = 20
M_FLOATER_INITIAL_ARMOR                  = 150	-- 750
M_FLOATER_ADDON_ARMOR                    = 60
M_FLYER_INITIAL_HEALTH					 = 50	-- 250
M_FLYER_ADDON_HEALTH					 = 20
M_FLYER_INITIAL_ARMOR					 = 50	-- 250
M_FLYER_ADDON_ARMOR						 = 20
M_GLADIATOR_INITIAL_HEALTH               = 100	-- 200
M_GLADIATOR_ADDON_HEALTH                 = 10
M_GLADIATOR_INITIAL_ARMOR                = 100	-- 300
M_GLADIATOR_ADDON_ARMOR                  = 20
M_GUNNER_INITIAL_HEALTH					 = 50	-- 300
M_GUNNER_ADDON_HEALTH					 = 25
M_GUNNER_INITIAL_ARMOR					 = 50	-- 200
M_GUNNER_ADDON_ARMOR					 = 15
M_HOVER_INITIAL_HEALTH					 = 50	-- 150
M_HOVER_ADDON_HEALTH					 = 10
M_HOVER_INITIAL_ARMOR					 = 50	-- 350
M_HOVER_ADDON_ARMOR						 = 30
M_MEDIC_INITIAL_HEALTH					 = 100	-- 200
M_MEDIC_ADDON_HEALTH					 = 10
M_MEDIC_INITIAL_ARMOR					 = 100	-- 300
M_MEDIC_ADDON_ARMOR						 = 20
M_MUTANT_INITIAL_HEALTH					 = 150	-- 1000
M_MUTANT_ADDON_HEALTH					 = 85
M_MUTANT_INITIAL_ARMOR					 = 0
M_MUTANT_ADDON_ARMOR					 = 0
M_PARASITE_INITIAL_HEALTH                = 150	-- 1000
M_PARASITE_ADDON_HEALTH                  = 85
M_PARASITE_INITIAL_ARMOR                 = 0
M_PARASITE_ADDON_ARMOR                   = 0
M_TANK_INITIAL_HEALTH					 = 100	-- 750
...
M_BRAIN_ADDON_PULL				=	-2
M_BRAIN_MAX_PULL				=	-80
M_BRAIN_INITIAL_TENTACLE_DMG	=	8
M_BRAIN_ADDON_TENTACLE_DMG		=	0.75
M_BRAIN_MAX_TENTACLE_DMG		=	0
M_GRENADELAUNCHER_DMG_BASE		=	20
M_GRENADELAUNCHER_DMG_ADDON		=	1.25
M_GRENADELAUNCHER_DMG_MAX		=	0
M_GRENADELAUNCHER_SPEED_BASE	=	600
M_GRENADELAUNCHER_SPEED_ADDON	=	30
M_GRENADELAUNCHER_SPEED_MAX		=	900
M_ROCKETLAUNCHER_DMG_BASE		=	30
M_ROCKETLAUNCHER_DMG_ADDON		=	2.5
M_ROCKETLAUNCHER_DMG_MAX		=	0
M_ROCKETLAUNCHER_SPEED_BASE		=	650
M_ROCKETLAUNCHER_SPEED_ADDON	=	20
M_ROCKETLAUNCHER_SPEED_MAX		=	950
M_SHOTGUN_DMG_BASE				=	5
M_SHOTGUN_DMG_ADDON				=	1
M_SHOTGUN_DMG_MAX				=	0
M_RAILGUN_DMG_BASE				=	20
M_RAILGUN_DMG_ADDON				=	1.5
M_RAILGUN_DMG_MAX				=	0
M_MELEE_DMG_BASE				=	30
M_MELEE_DMG_ADDON				=	2
M_MELEE_DMG_MAX					=	0
M_HYPERBLASTER_DMG_BASE			=	2
M_HYPERBLASTER_DMG_ADDON		=	0.25
M_HYPERBLASTER_DMG_MAX			=	0
M_MACHINEGUN_DMG_BASE			=	6
M_MACHINEGUN_DMG_ADDON			=	0.75
M_MACHINEGUN_DMG_MAX			=	0
M_BLASTER_DMG_BASE				=	15
M_BLASTER_DMG_ADDON				=	1.25
M_BLASTER_DMG_MAX				=	0
M_BLASTER_SPEED_BASE			=	1000
M_BLASTER_SPEED_ADDON			=	50
M_BLASTER_SPEED_MAX				=	1500
M_20MM_RANGE_BASE				=	750
M_20MM_RANGE_ADDON				=	0
M_20MM_RANGE_MAX				=	750
M_20MM_DMG_BASE					=	10
M_20MM_DMG_ADDON				=	0.75
M_20MM_DMG_MAX					=	0


-- 20mm cannon
WEAPON_20MM_INITIAL_DMG                  = 40
WEAPON_20MM_ADDON_DMG                    = 3
WEAPON_20MM_INITIAL_RANGE                = 550
WEAPON_20MM_ADDON_RANGE                  = 30

-- Player Parasite
PARASITE_ATTACK_RANGE			=	96
PARASITE_INITIAL_KNOCKBACK		=	-60
PARASITE_ADDON_KNOCKBACK		=	-2
PARASITE_MAX_KNOCKBACK			=	-80
PARASITE_INITIAL_DMG			=	3
PARASITE_ADDON_DMG				=	0.5
PARASITE_MAX_DMG				=	0
...
P_TANK_PUNCH_INITIAL_DMG                 = 50
P_TANK_PUNCH_ADDON_DMG                   = 25
P_TANK_BLASTER_INITIAL_DMG               = 50
P_TANK_BLASTER_ADDON_DMG                 = 10
P_TANK_BLASTER_INITIAL_SPD               = 1500
P_TANK_BLASTER_ADDON_SPD                 = 55
P_TANK_ROCKET_INITIAL_DMG                = 50
P_TANK_ROCKET_ADDON_DMG                  = 10
...
P_TANK_ADDON_ROCKETS                     = 5
P_TANK_SPAWN_ROCKETS                     = 15
P_TANK_INITIAL_BULLETS                   = 150
P_TANK_ADDON_BULLETS                     = 30
P_TANK_SPAWN_BULLETS                     = 75
P_TANK_INITIAL_CELLS                     = 45
P_TANK_ADDON_CELLS                       = 5
P_TANK_SPAWN_CELLS                       = 25
P_TANK_MAX_AMMO                          = 125
P_TANK_INIT_COST                         = 50
...
BRAIN_DEFAULT_TENTACLE_DMG               = 20
BRAIN_ADDON_TENTACLE_DMG                 = 3
BRAIN_BEAM_COST                          = 2
...
CTF_FLAG_CAPTURE_EXP                     = 1000
CTF_FLAG_ASSIST_EXP                      = 200
CTF_FLAG_CAPTURE_CREDITS                 = 500
CTF_MINIMUM_PLAYERS                      = 4
CTF_FLAG_DEFEND_RANGE                    = 512
CTF_BASE_DEFEND_RANGE                    = 1024
CTF_FLAG_DEFEND_EXP                      = 100
CTF_FLAG_DEFEND_CREDITS                  = 50
CTF_FLAG_KILL_EXP                        = 100
CTF_FLAG_KILL_CREDITS                    = 50
CTF_BASE_DEFEND_EXP                      = 50
CTF_BASE_DEFEND_CREDITS                  = 25
CTF_BASE_KILL_EXP                        = 50
CTF_BASE_KILL_CREDITS                    = 25
CTF_FLAG_RETURN_EXP                      = 50
CTF_FLAG_RETURN_CREDITS                  = 25
CTF_FLAG_TAKE_EXP                        = 100
CTF_FLAG_TAKE_CREDITS                    = 50
CTF_FRAG_EXP                             = 50
CTF_FRAG_CREDITS                         = 25
CTF_PLAYERSPAWN_HEALTH                   = 0
CTF_PLAYERSPAWN_CAPTURE_EXPERIENCE       = 0
CTF_PLAYERSPAWN_CAPTURE_CREDITS          = 0
CTF_PLAYERSPAWN_DEFENSE_RANGE            = 512
CTF_PLAYERSPAWN_DEFENSE_EXP              = 0
CTF_PLAYERSPAWN_DEFENSE_CREDITS          = 0
CTF_PLAYERSPAWN_OFFENSE_EXP              = 0
CTF_PLAYERSPAWN_OFFENSE_CREDITS          = 0
CTF_PLAYERSPAWN_TIME                     = 1.0
CTF_PLAYERSPAWN_MAX_TIME                 = 1.0
...
CLIGHTNING_ADDON_DMG                     = 20
CLIGHTNING_INITIAL_AR                    = 512
